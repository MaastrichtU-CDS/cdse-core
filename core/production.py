...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("SQL_DATABASE_DJANGO", os.path.join(BASE_DIR, "db.sqlite3")),
        "USER": os.environ.get("SQL_USER_DJANGO", "user"),
        "PASSWORD": os.environ.get("SQL_PASSWORD_DJANGO", "password"),
